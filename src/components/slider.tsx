...
useEffect(() => {
  ...
  return () => clearTimeout(timer);
    ...
    return(
            <div className={`h-[300px] bg-gray-300 rounded-2xl w-[500px] mx-auto  flex flex-col items-center relative overflow-hidden md:mt-0 md:-left-18 md:-mb-12 transition-all -mt-20 duration-700 ease-out ${visible ? "opacity-100 translate-y-0":"opactiy-0 translate-y-20"} `}>
