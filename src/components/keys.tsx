    ...
    return(
        <div className="flex flex-col items-center gap-2">
            ...
            <div className="flex gap-2 ">
                {row1.map(key=>(
            <button key={key} {...events} className=" px-4 py-2.5 rounded-lg text-gray-500 bg-zinc-900 relative overflow-hidden rounded-lg transition-all duration-300 hover:translate-x-1 hover:shadow-[0_0_8px_2px_rgba(0,153,255,1)]
cursor-pointer
             shadow-[0_0_6px_rgba(255,255,255,0.85)] text-white font-semibold text-[12px]">{key}</button>
             ))}
           </div>

            <div className="flex gap-2"><button {...events} className="px-8 py-2.5 rounded-lg relative overflow-hidden rounded-lg transition-all duration-300 hover:translate-x-1 hover:shadow-[0_0_8px_2px_rgba(0,153,255,1)]
cursor-pointer  text-gray-500 bg-zinc-900
            ...
            <button key={key} {...events} className="  text-gray-500 bg-zinc-900 relative overflow-hidden rounded-lg transition-all duration-300 hover:translate-x-1 hover:shadow-[0_0_8px_2px_rgba(0,153,255,1)]
cursor-pointer
             shadow-[0_0_6px_rgba(255,255,255,0.85)] text-white font-semibold text-[12px] px-4 py-2.5 rounded-lg text-gray-500 ">{key}</button>
            ))}</div>
            
            <div className="flex gap-2">
                <button {...events} className="px-5 text-[12px] py-2.5 rounded-lg  relative overflow-hidden rounded-lg transition-all duration-300 hover:translate-x-1 hover:shadow-[0_0_8px_2px_rgba(0,153,255,1)]
cursor-pointertext-gray-500 text-white font-semibold  text-gray-500 bg-zinc-900 
            ...
            <button key={key} {...events} className="px-4 py-2.5 rounded-lg text-gray-500  relative overflow-hidden rounded-lg transition-all duration-300 hover:translate-x-1 hover:shadow-[0_0_8px_2px_rgba(0,153,255,1)]
cursor-pointer text-gray-500 bg-zinc-900
             shadow-[0_0_6px_rgba(255,255,255,0.85)] text-white font-semibold text-[12px]">{key}</button>
            
            ))}
            <button {...events} className="px-7 py-2.5 rounded-lg text-gray-500 text-white font-semibold text-[12px]  text-gray-500 bg-zinc-900 relative overflow-hidden rounded-lg transition-all duration-300 hover:translate-x-1 hover:shadow-[0_0_8px_2px_rgba(0,153,255,1)]
cursor-pointer 
             shadow-[0_0_6px_rgba(255,255,255,0.85)] text-[12px]">enter</button></div>

            <div className="flex gap-2">
                <button {...events} className="px-10 py-2.5 rounded-lg text-gray-500  relative overflow-hidden rounded-lg transition-all duration-300 hover:translate-x-1 hover:shadow-[0_0_8px_2px_rgba(0,153,255,1)]
...
cursor-pointer font-semibold text-white text-gray-500 bg-zinc-900
            ...
            <button {...events} className="px-11 py-2.5 rounded-lg text-gray-500 text-white font-semibold text-[12px]  relative overflow-hidden rounded-lg transition-all duration-300 hover:translate-x-1 hover:shadow-[0_0_8px_2px_rgba(0,153,255,1)]
cursor-pointer text-gray-500 bg-zinc-900 
